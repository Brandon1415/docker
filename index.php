...
<div class="hero d-flex justify-content-center align-items-center" 
    ...
    <div class="container">
        ...
        <div class="center-container" style="display: flex; flex-direction: column; align-items: center; margin-top: 30px;">
            <a href="https://drive.google.com/drive/folders/1d9cSmRHAnhYO5ar7CTFDIni4-qvOKr3n?usp=drive_link" 
               target="_blank" 
               style="display:inline-block; width: 250px; background: white; padding: 15px; border-radius: 15px; shadow: 0 4px 15px rgba(0,0,0,0.2);">
                <img src="QR2025Movil.png" alt="Escanear para descargar APK" style="width: 100%; height: auto; display: block;"/>
                <p class="text-dark fw-bold mt-2 mb-0" style="font-size: 12px;">ESCANEAME PARA DESCARGAR</p>
            </a>
        </div>
    </div>
</div>
